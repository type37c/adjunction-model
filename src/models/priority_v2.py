"""
Priority Computation V2: coherence × uncertainty (WITHOUT valence)

This is a simplified version of the priority computation that does NOT include valence.
It is used for Condition 1 (baseline) and as a reference implementation.
...
class PriorityComputationV2(nn.Module):
    """
    Compute priority scores for spatial breakdowns WITHOUT valence.
