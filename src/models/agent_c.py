"""
Agent Layer C: With Intrinsic Reward-based Purpose Space P

This is the canonical Agent Layer C implementation that incorporates:
1. Spatial coherence, priority, and valence
...
if __name__ == '__main__':
    ...
    print("="*60)
    print("Agent Layer C implements Intrinsic Reward-based Purpose Space P:")
